...
public class Forest7 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest7.class.getName());
    ...
    */
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest7.GEM: drawGem(g, x, y);  break;
                case Forest7.COIN: drawCoin(g, x, y);  break;
                case Forest7.VASE: drawVase(g, x, y);  break;
				case Forest7.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
