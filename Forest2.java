...
public class Forest2 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest2.class.getName());
    ...
    */
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest2.GEM: drawGem(g, x, y);  break;
                case Forest2.COIN: drawCoin(g, x, y);  break;
                case Forest2.VASE: drawVase(g, x, y);  break;
				case Forest2.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
