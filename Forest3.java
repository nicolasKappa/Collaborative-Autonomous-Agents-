...
public class Forest3 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest3.class.getName());
    ...
    */
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest3.GEM: drawGem(g, x, y);  break;
                case Forest3.COIN: drawCoin(g, x, y);  break;
                case Forest3.VASE: drawVase(g, x, y);  break;
				case Forest3.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
