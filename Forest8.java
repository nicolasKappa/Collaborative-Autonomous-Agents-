...
public class Forest8 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest8.class.getName());
    ...
    */
    void updatePercepts() {
		...
		if(model.hasObject(TELEPORTER, heroLoc)){
			...
			System.out.println("~~~~~ TELEPORT ~~~~~> " + 5 + "," + 7);
			model.setAgPos(0, 5,7);
		}
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest8.GEM: drawGem(g, x, y);  break;
                case Forest8.COIN: drawCoin(g, x, y);  break;
                case Forest8.VASE: drawVase(g, x, y);  break;
				case Forest8.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
