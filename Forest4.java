...
public class Forest4 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest4.class.getName());
    ...
    */
    void updatePercepts() {
		...
		if(model.hasObject(TELEPORTER, heroLoc)){
			...
			System.out.println("~~~~~ TELEPORT ~~~~~> " + 6 + "," + 1);
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest4.GEM: drawGem(g, x, y);  break;
                case Forest4.COIN: drawCoin(g, x, y);  break;
                case Forest4.VASE: drawVase(g, x, y);  break;
				case Forest4.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
