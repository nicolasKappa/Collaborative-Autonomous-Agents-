...
public class Forest6 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest6.class.getName());
    ...
    */
    ...
    class ForestModel extends GridWorldModel {
        ...
        private ForestModel() {
            ...
            //No Objects are placed in the forest for this test
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest6.GEM: drawGem(g, x, y);  break;
                case Forest6.COIN: drawCoin(g, x, y);  break;
                case Forest6.VASE: drawVase(g, x, y);  break;
				case Forest6.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
