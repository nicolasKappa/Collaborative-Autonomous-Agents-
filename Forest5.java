...
public class Forest5 extends Environment {
    ...
    */
    ...
    static Logger logger = Logger.getLogger(Forest5.class.getName());
    ...
    */
    ...
    class ForestView extends GridWorldView {
        ...
        public void draw(Graphics g, int x, int y, int object) {
            switch (object) {
                case Forest5.GEM: drawGem(g, x, y);  break;
                case Forest5.COIN: drawCoin(g, x, y);  break;
                case Forest5.VASE: drawVase(g, x, y);  break;
				case Forest5.TELEPORTER: drawTeleporter(g,x,y); break;
            }
        }
